#define MyAppName "Ultimate Dart Tag (Fly Hack)"
#define MyAppVersion "1.0.2"
#define MyAppExeName "Ultimate Dart Tag (Fly Hack).exe"
#define MyBuildDir "..\Built EXE"

[Setup]
AppId={{B362318E-5C47-490F-BEF5-6F5B94D38AA5}
AppName={#MyAppName}
...
OutputDir=Output
OutputBaseFilename=UltimateDartTagFlyHack-Setup
Compression=lzma2
...
Source: "{#MyBuildDir}\Ultimate Dart Tag (Fly Hack)_Data\*"; DestDir: "{app}\Ultimate Dart Tag (Fly Hack)_Data"; Flags: ignoreversion recursesubdirs createallsubdirs
